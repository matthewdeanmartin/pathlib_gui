...
def ask_copy_destination(parent: tk.Widget, source_name: str) -> Path | None:
...
def ask_move_destination(parent: tk.Widget, source_name: str) -> Path | None:
...
def ask_save_file(parent: tk.Widget, initial_name: str = "") -> Path | None:
