...
echo "=== pathlib_gui basic_checks ==="
echo ""
echo "using: ${CLI_PYTHON} -m pathlib_gui"
echo ""

echo "--- global flags ---"
check "pathlib_gui --help"    run_cli --help
check "pathlib_gui --version" run_cli --version

# TODO: add subcommand smoke checks here, e.g.:
# check "pathlib_gui <subcommand> --help"  run_cli <subcommand> --help
